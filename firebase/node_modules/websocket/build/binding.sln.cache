<Project DefaultTargets="Build" ToolsVersion="2.0" InitialTargets="ValidateSolutionConfiguration;ValidateToolsVersions" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup>
    <SolutionDir>D:\Vishvam\Programming Projects\Hackathons\HackTheNorth2018\htn-2018\firebase\node_modules\websocket\build\</SolutionDir>
    <SolutionExt>.sln</SolutionExt>
    <SolutionFileName>binding.sln</SolutionFileName>
    <SolutionName>binding</SolutionName>
    <SolutionPath>D:\Vishvam\Programming Projects\Hackathons\HackTheNorth2018\htn-2018\firebase\node_modules\websocket\build\binding.sln</SolutionPath>
  </PropertyGroup>
  <PropertyGroup>
  ...
  <PropertyGroup Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') ">
    <CurrentSolutionConfigurationContents>
      <SolutionConfiguration xmlns="">
        <ProjectConfiguration Project="{668952C6-3CE3-59E0-BCD4-4FC9D80A26B9}">Debug|x64</ProjectConfiguration>
        <ProjectConfiguration Project="{B93211B1-CA4D-AB7E-ABA0-F7DB53353458}">Debug|x64</ProjectConfiguration>
  ...
  <PropertyGroup Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') ">
    <CurrentSolutionConfigurationContents>
      <SolutionConfiguration xmlns="">
        <ProjectConfiguration Project="{668952C6-3CE3-59E0-BCD4-4FC9D80A26B9}">Release|x64</ProjectConfiguration>
        <ProjectConfiguration Project="{B93211B1-CA4D-AB7E-ABA0-F7DB53353458}">Release|x64</ProjectConfiguration>
      </SolutionConfiguration>
    </CurrentSolutionConfigurationContents>
  </PropertyGroup>
  ...
  <Target Name="validation" Condition="'$(CurrentSolutionConfigurationContents)' != ''">
    <VCBuild Projects="D:\Vishvam\Programming Projects\Hackathons\HackTheNorth2018\htn-2018\firebase\node_modules\websocket\build\validation.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Debug|x64" SolutionFile="D:\Vishvam\Programming Projects\Hackathons\HackTheNorth2018\htn-2018\firebase\node_modules\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') " />
    <VCBuild Projects="D:\Vishvam\Programming Projects\Hackathons\HackTheNorth2018\htn-2018\firebase\node_modules\websocket\build\validation.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Release|x64" SolutionFile="D:\Vishvam\Programming Projects\Hackathons\HackTheNorth2018\htn-2018\firebase\node_modules\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') " />
  </Target>

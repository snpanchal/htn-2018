<Project DefaultTargets="Build" ToolsVersion="2.0" InitialTargets="ValidateSolutionConfiguration;ValidateToolsVersions" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup>
    <SolutionDir>D:\Vishvam\Programming Projects\Hackathons\HackTheNorth2018\htn-2018\firebase\functions\node_modules\websocket\build\</SolutionDir>
    <SolutionExt>.sln</SolutionExt>
    <SolutionFileName>binding.sln</SolutionFileName>
    <SolutionName>binding</SolutionName>
    <SolutionPath>D:\Vishvam\Programming Projects\Hackathons\HackTheNorth2018\htn-2018\firebase\functions\node_modules\websocket\build\binding.sln</SolutionPath>
  </PropertyGroup>
  <PropertyGroup>
  ...
  <PropertyGroup Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') ">
    <CurrentSolutionConfigurationContents>
      <SolutionConfiguration xmlns="">
        <ProjectConfiguration Project="{40D4472C-F45C-6032-9228-6C187B75DDFD}">Debug|x64</ProjectConfiguration>
        <ProjectConfiguration Project="{EFA8F519-7CF4-1219-D55A-3DC3ABF4D0B1}">Debug|x64</ProjectConfiguration>
  ...
  <PropertyGroup Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') ">
    <CurrentSolutionConfigurationContents>
      <SolutionConfiguration xmlns="">
        <ProjectConfiguration Project="{40D4472C-F45C-6032-9228-6C187B75DDFD}">Release|x64</ProjectConfiguration>
        <ProjectConfiguration Project="{EFA8F519-7CF4-1219-D55A-3DC3ABF4D0B1}">Release|x64</ProjectConfiguration>
      </SolutionConfiguration>
    </CurrentSolutionConfigurationContents>
  </PropertyGroup>
  ...
  <Target Name="bufferutil" Condition="'$(CurrentSolutionConfigurationContents)' != ''">
    <VCBuild Projects="D:\Vishvam\Programming Projects\Hackathons\HackTheNorth2018\htn-2018\firebase\functions\node_modules\websocket\build\bufferutil.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Debug|x64" SolutionFile="D:\Vishvam\Programming Projects\Hackathons\HackTheNorth2018\htn-2018\firebase\functions\node_modules\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') " />
    <VCBuild Projects="D:\Vishvam\Programming Projects\Hackathons\HackTheNorth2018\htn-2018\firebase\functions\node_modules\websocket\build\bufferutil.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Release|x64" SolutionFile="D:\Vishvam\Programming Projects\Hackathons\HackTheNorth2018\htn-2018\firebase\functions\node_modules\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') " />
  </Target>
  ...
  <Target Name="validation" Condition="'$(CurrentSolutionConfigurationContents)' != ''">
    <VCBuild Projects="D:\Vishvam\Programming Projects\Hackathons\HackTheNorth2018\htn-2018\firebase\functions\node_modules\websocket\build\validation.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Debug|x64" SolutionFile="D:\Vishvam\Programming Projects\Hackathons\HackTheNorth2018\htn-2018\firebase\functions\node_modules\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') " />
    <VCBuild Projects="D:\Vishvam\Programming Projects\Hackathons\HackTheNorth2018\htn-2018\firebase\functions\node_modules\websocket\build\validation.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Release|x64" SolutionFile="D:\Vishvam\Programming Projects\Hackathons\HackTheNorth2018\htn-2018\firebase\functions\node_modules\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') " />
  </Target>
